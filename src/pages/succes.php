                ...
                <div
                    ...
                    <div class="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                        <div class=" flex flex-col items-center text-center justify-center">
                            <div
                                class="mx-auto flex flex-shrink-0 items-center justify-center rounded-full sm:mx-0 sm:h-10 sm:w-10 ">
                                <script src="https://cdn.lordicon.com/lordicon.js"></script>
                                <lord-icon src="https://cdn.lordicon.com/wyjhrzdh.json" trigger="loop" delay="600"
                                    state="in-reveal" colors="secondary:#16c72e,primary:#30e849"
                                    style="width:100px;height:100px">
                                </lord-icon>
                            </div>
                            <div class="mt-3 flex flex-col items-center sm:ml-4 sm:mt-0 sm:text-left text-center">
                                <h3 class="text-base font-semibold leading-6 text-[#22c55e]" id="modal-title">Success
                                </h3>
                                <div class="mt-2">
                                    <p class="text-sm text-gray-400 text-bold font-semibold">The mail has been sent successfully</p>
