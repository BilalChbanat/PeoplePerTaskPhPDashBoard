...
<body class="">
    ...
    if (isset($_POST['save'])) {
        ...
        if (empty($title_projet)) {
            ...
            $sqlAddcat = "INSERT INTO offres (montant, delai, id_projet) 
                    VALUES ('$title_projet', '$descreption', $id_cat)";
    ...
    if (mysqli_num_rows($re) > 0):
        ...
        while ($row = mysqli_fetch_assoc($re)):
            echo "<option value=" . $row['id_projet'] . ">" . $row['id_projet'] . "-" . $row['title_projet'] . "</option>";
        endwhile;
        $optcat = ob_get_clean();
    endif;
    ?>
                                ...
                                <form class="p-4 md:p-5" method="POST">
                                    <div class="grid gap-4 mb-4 grid-cols-2">
                                        <div class="col-span-2">
                                            ...
                                            <input type="number" name="title_projet" id="name"
                                        ...
                                        <div class="col-span-2">
                                            <label for="description"
                                                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Delai
                                            </label>
                                            <input id="description" rows="4" name="description" type="number"
                                                class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                placeholder="Write Delai here"></input>
                                        </div>
                                    </div>
