...
<body class="bg-body-bg bg-cover bg-center">
  ...
  <main>
    <div
      class=" max-w-2xl  mx-auto h-fit my-12 bg-white px-8 py-4 pb-1 mt-16 rounded-xl shadow shadow-slate-200 drop-shadow-lg dark:bg-mainColorDark dark:shadow-slate-900 sm: w-full">
      <form action="" class="my-10">
        <div class="flex flex-col space-y-5">
          <div class=" flex flex-row items-center gap-8">
            <button
              class="flex flex-col items-center w-1/2 h-44 bg-white border-zinc-200 border-[0.1rem] p-8 pt-6 rounded-xl text-center font-bold text-xl text-mainBlue font-poppins dark:text-mainPurple  hover:text-white hover:bg-mainBlue hover:border-none  dark:hover:bg-mainPurple dark:hover:text-white dark:bg-cardGrey">
              <i class="ri-user-3-line font-extralight text-3xl"></i>
              <a href="">I’m a client, hiring<br>for a project</a>
            </button>
            <button
              class="flex flex-col items-center w-1/2 h-44 bg-white border-zinc-200 border-[0.1rem] p-8 pt-6 rounded-xl text-center font-bold text-xl text-mainBlue font-poppins hover:text-white dark:text-mainPurple hover:bg-mainBlue hover:border-none dark:hover:bg-mainPurple dark:hover:text-white dark:bg-cardGrey">
          ...
          <h2 class="text-center font-poppins text-sm text-black dark:text-white">Already have an account? <a
              class="text-mainBlue dark:text-mainPurple" href="#">Log in</a></h2>
        </div>
      </form>
    </div>
  </main>
