          ...
          <ul class="flex justify-center items-center gap-4 flex-col">
            ...
            <li class="flex ht:hidden justify-center items-center gap-3 flex-col">
              ...
              <a href="src/pages/dashclient.php"
                class="text-slate-50 rounded-full bg-mainBlue py-2 px-8 flex justify-center items-center dark:bg-mainPurple font-poppins text-base font-medium w-[18rem]">Dash
                Board</a>
            </li>
            <li>
              <button id="theme-toggle" type="button"
  ...
  <main class="px-16 herothird:px-8">
    ...
    <section class="flex justify-center items-center flex-col pt-12 w-full gap-12 relative">
      ...
      <div class="owl-carousel">
        <div
          class="flex justify-center items-center flex-col gap-6 w-[330px] rounded-[18px] bg-white dark:bg-cardGrey shadow-[0px_2px_28px_0px_#3E35780A] drop-shadow-[0px_2px_28px_0px_#3E35780A] p-7">
        ...
        <div
          ...
          <div class="flex justify-start items-center gap-4 w-full">
            <div class="flex justify-center items-center relative">
              <img src="./images/avatar-3.jpg.svg" alt="avatar-img">
              <img src="./images/div.profile-online-status-active.svg" alt="online-status"
                class="absolute bottom-[-0.4rem] right-0">
            </div>
            <div class="flex justify-center items-start gap-1 flex-col">
              <div>
    ...
    <section class="flex justify-center items-center pt-8">
      <button type="button"
        class="text-slate-50 rounded-full bg-mainBlue py-3 px-8 flex justify-center items-center dark:bg-mainPurple font-poppins text-base font-medium w-[12rem]">View
        More</button>
    </section>
    <section class="flex justify-center items-center flex-col pt-12 w-full gap-8">
      <div
